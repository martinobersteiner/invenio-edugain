...
//   - changed settings for Graz University of Technology purposes
...
export function IdPSelectUIParms() {
  ...
  this.defaultReturn = "https://invenio01-demo.tugraz.at/saml/login/authn-request"; // If non null, then the default place to send users who are not
  // Approaching via the Discovery Protocol for example
  //this.defaultReturn = "https://example.org/Shibboleth.sso/DS?SAMLDS=1&target=https://example.org/secure";
  this.defaultReturnIDParam = null;
  this.redirectAllow = ["^https:\/\/invenio01-demo.tugraz.at.*$"];
