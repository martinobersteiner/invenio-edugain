...
//   - changed settings for TU Graz purposes
...
export function IdPSelectUIParms() {
  ...
  this.defaultReturn = "https://localhost:5000/saml/login/authn-request"; // If non null, then the default place to send users who are not
  // Approaching via the Discovery Protocol for example
  //this.defaultReturn = "https://example.org/Shibboleth.sso/DS?SAMLDS=1&target=https://example.org/secure";
  this.defaultReturnIDParam = null;
  this.redirectAllow = ["^https:\/\/localhost:5000.*$"];
