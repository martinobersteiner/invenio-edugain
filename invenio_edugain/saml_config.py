...
logging_config_dict = {
    ...
    "handlers": {
        "file": {
            ...
            "filename": "/opt/invenio/var/instance/logs/edugain.log",
            "level": "DEBUG",
            "formatter": "simple",
        },
    },
...
config_dict = {
    ...
    "key_file": "edugain/signing.key",
    "cert_file": "edugain/signing.crt",
    "encryption_keypairs": [
        ...
        {"key_file": "edugain/encryption.key", "cert_file": "edugain/encryption.crt"},
    ],
    "xmlsec_binary": get_xmlsec_binary(["/opt/local/bin", "usr/local/bin"]),
}

# TODO: instantiate a saml2 thing at startup as to fail early on this?
