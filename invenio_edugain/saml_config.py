...
#       in the meantime, here's a dummy
"""Dummy config for our SP.

This is a static dummy configuration as a stand-in until actual configuration story is implemented.
"""
...
logging_config_dict = {  # TODO: logging
    "version": 1,
    "formatters": {
        "simple": {
    ...
    "handlers": {
        "file": {
            ...
            "filename": "/home/obersteiner/tests/edulog/log",  # TODO: set filepath for demo-server
            "level": "DEBUG",
            "formatter": "simple",
        },
    },
...
config_dict = {
    ...
    "entityid": "https://localhost:5000/saml/sp/xml",  # used for <Issuer> element  # TODO: compute from flask-config
    "entity_attributes": [
        {
